...
*/
$emailto = 'alexkerri.brown@gmail.com'; 	// Insert the email address that will receive the messages
$fromName = 'Wedding RSVP!';					// Insert a default "Name" email address (this field will be displayed in the email header)
$fromEmail = 'default@yourdomain.com';	// Insert a default "From" email address (this field will be displayed in the email header)
$subject = 'RSVP - Kerri & Alex Wedding';		// Insert a default contact form subject
